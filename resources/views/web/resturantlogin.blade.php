...
<html>
   <head>
      ...
      <link href="https://fonts.googleapis.com/css?family=Philosopher&display=swap" rel="stylesheet">
         <style>
          .login_banner79 {
                background: linear-gradient(rgba(22, 9, 11, .3), rgba(172, 2, 2, .1)), url(public/frontassets/image/restuarent.jpg);
        ...
        ?>
         <div class="row">
            ...
            @if (count($errors) > 0)
                  ...
                  @endif
                 @endif
            <form method="POST" action="{{route('resturantlogin')}}">
            {{csrf_field()}}
               ...
               <br>
               <center>
               <p class="forgot_login"><a  href="{{ route('resturantforgotpassword') }}">Forgot your password?</a></p>
                    <p style="font-size: 14px;">Don't have an account? <a  href="{{ route('resturantsignup') }}">Sign up</a></p>
               </center>
            </div>
