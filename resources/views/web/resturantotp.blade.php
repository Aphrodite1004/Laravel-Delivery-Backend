      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-sm-6 login_banner79">
                 <!--<img src="public/frontassets/image/restuarent.jpg">-->
            </div>
            <div class="col-sm-6" style="padding: 80px 140px 170px 140px;">
               <br><br>
               <form method="POST" action="{{route('resturantotpverifyforgot')}}">
            {{csrf_field()}}
               ...
               <br>
               <center>
                  <p class="forgot_already">ALready an account? <a  href="{{ route('resturantweblogin') }}">Sign in</a></p>
               </center>
            </div>
         </div>
      </div>
