   ...
   <body>
      ...
      <section id="services" class="services section-bg">
         <div class="container-fluid" style="width: 92.2%;padding-top: 55px;">
            ...
            <div class="card-body">
            <form method="POST" action="{{ route('addreceiveraddress') }}">
             {{ csrf_field()}}
              ...
              <div class="row" style="padding-top: 10px">
               ...
               <input type="hidden" name="storeid" value="{{$storeid}}">
                ...
                <div class="col-md-6"><label>Receiver Name</label><input type="text" class="form-control" name="receivername"></div>
                 <div class="col-md-6"><label>Receiver Contact No</label><input type="text" class="form-control" name="receivercontact"></div>
              </div>
              <div class="row" style="padding-top: 10px">
                 <!-- <div class="col-md-2"></div> -->
                <div class="col-md-12"><label>Address</label>
                  <textarea class="form-control"  name="receiveraddress"></textarea>
                </div>
                </div>
             
               <div class="row" style="padding-top: 10px">
              <!--   <div class="col-md-2"></div> -->
                <div class="col-md-4"><label>House No</label><input type="text" class="form-control"  name="receiverhouseno"></div>
                <div class="col-md-4"><label>Pincode</label><input type="text" class="form-control" name="receiverpincode"></div>
                <div class="col-md-4"><label>Landmark</label><input type="text" class="form-control" name="receiverlandmark"></div>
                </div>
                <div class="row" style="padding-top: 10px">
                  <!--  <div class="col-md-2"></div> -->
                <div class="col-md-6"><label>City</label><input type="text" class="form-control" name="receivercity"></div>
                <div class="col-md-6"><label>State</label><input type="text" class="form-control" name="receiverstate"></div>
