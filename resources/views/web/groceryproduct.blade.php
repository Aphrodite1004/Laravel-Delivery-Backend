                  ...
                  <div class="card product_sidebar" id="categoryiddata">
                     ...
                     <div class="card-body side_price_scroll">
                        <form style="margin-left: -10px;">
                           ...
                           <input type="checkbox"  id="fruit<?php echo $i;?>" name="fruit-<?php echo $i;?>" value="<?php echo $categorydata->category_id;?>" onclick="getproduct('<?php echo $i;?>','<?php echo $categorydata->category_id;?>','')">
                           <label for="fruit<?php echo $i;?>"><?php echo $categorydata->category_name;?></label>
                           <?php $i++;}?>
                           ...
                           <div class="col-lg-3 col-md-6 d-flex align-items-stretch" >
                              ...
                              <a href="product_detail.php">
                                 <div class="member-img">
                                    <center>
                                    <a href="{{ route('productdetail',['id' =>$products['subcat_id'],'storeid' => $products['vendor_id']]) }}">
                                 ...
                                 <div class="member-info">
                                    ...
                                    @foreach($products['data'] as $varient)
                                       <option value="{{ $varient->varient_id }}">{{ $varient->quantity }}{{ $varient->unit }}</option>
                                       @endforeach
                                    </select>
                                    @foreach($products['data'] as $varient)
                                    @if ($loop->first)  
   ...
   $(document).ready(function(){
      ...
      $('select[name="varient_id"]').on('change', function() {
        ...
        var varient_id = $(this).val();
                debugger;
                $.ajax({
                    url: "getbyvarient/"+encodeURI(varient_id),
                    type: "GET",
                    dataType: "json",
