   ...
   <body>
      ...
      <section id="services" class="services section-bg">
         <div class="container-fluid" style="width: 92.2%;padding-top: 55px;">
            ...
            <div class="card-body">
            <form method="POST" action="{{ route('addsenderaddress') }}">
             {{ csrf_field()}}

              <div class="row" style="padding-top: 10px">
               <!--  <div class="col-md-2"></div> -->
               <input type="hidden" name="storeid" value="{{$storeid}}">
                <div class="col-md-6"><label>Sender Name</label><input type="text" class="form-control" name="sendername"></div>
                 <div class="col-md-6"><label>Sender Contact No</label><input type="text" class="form-control" name="sendercontact"></div>
              </div>
              <div class="row" style="padding-top: 10px">
                 <!-- <div class="col-md-2"></div> -->
                <div class="col-md-12"><label>Address</label>
                  <textarea class="form-control"  name="senderaddress"></textarea>
                </div>
                </div>
             
               <div class="row" style="padding-top: 10px">
              <!--   <div class="col-md-2"></div> -->
                <div class="col-md-4"><label>House No</label><input type="text" class="form-control"  name="senderhouseno"></div>
                <div class="col-md-4"><label>Pincode</label><input type="text" class="form-control" name="senderpincode"></div>
                <div class="col-md-4"><label>Landmark</label><input type="text" class="form-control" name="senderlandmark"></div>
                </div>
                <div class="row" style="padding-top: 10px">
                  <!--  <div class="col-md-2"></div> -->
                <div class="col-md-6"><label>City</label><input type="text" class="form-control" name="sendercity"></div>
                <div class="col-md-6"><label>State</label><input type="text" class="form-control" name="senderstate"></div>
