...
<html>
   ...
   <body>
      <div class="container-fluid">
         ...
         <div class="row">
            <div class="col-sm-6 login_banner76" style="position: relative;">
            </div>
            ...
            @if (count($errors) > 0)
                  ...
                  @endif
                 @endif
            <form method="POST" action="{{route('groceryweblogin')}}">
            {{csrf_field()}}
               ...
               <br>
               <center>
               <p class="forgot_login"><a  href="{{ route('groceryforgotpassword') }}">Forgot your password?</a></p>
                    <p style="font-size: 14px;">Don't have an account? <a  href="{{ route('grocerysignup') }}">Sign up</a></p>
               </center>
            </div>
