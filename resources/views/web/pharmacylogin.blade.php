      ...
      <div class="container-fluid">
         ...
         <div class="row">
            ...
            @if (count($errors) > 0)
                  ...
                  @endif
                 @endif
            <form method="POST" action="{{route('pharmacyweblogin')}}">
            {{csrf_field()}}
               ...
               <br>
               <center>
                  <p class="forgot_login"><a  href="{{ route('pharmacyforgotpassword') }}">Forgot your password?</a></p>
                  <p style="font-size: 14px;">Don't have an account? <a  href="{{ route('pharmacysignup') }}">Sign up</a></p>
