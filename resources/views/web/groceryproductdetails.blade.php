       ...
       <!-- add code -->
               ...
               <div class="col-lg-6 order-2 order-lg-2 hero-img right_prodiv" id="productdetaildata">
                  ...
                  <select class="select_gram23 shadow-sm" id="productvar" onchange="changeproductdeatils(this,<?php echo $storeid;?>)">
                     ...
                     <option value="<?php echo $varient->varient_id;?>"><?php echo $varient->quantity.''.$varient->unit;?></option>
                     @endforeach
                  </select>
                  @foreach($products['data'] as $varient)
                                    @if ($loop->first)  
                  <input type="hidden" name="piddata" id="piddata" value="<?php echo $varient->product_id;?>">
                  <input type="hidden" name="varientiddata" id="varientiddata" value="<?php echo $varient->varient_id;?>">
                  ...
                  <p style="width: 90%;font-size: 13px;margin-top: 13px;color: #A6A6A6" id="description">{{$varient->description}}</p>
                  @endif
                  @endforeach
               </div>
               @endif
