                           ...
                           <div class="col-lg-3 col-md-6 d-flex align-items-stretch" >
                              ...
                              <a href="product_detail.php">
                                 <div class="member-img">
                                    <center>
                                    <a href="{{ route('resturantproductdetail',['id' =>$products['subcat_id'],'storeid' => $products['vendor_id']]) }}">
                                 ...
                                 <button class="plus-one inner_one2" onclick="getminus('<?php echo $i; ?>')"><i class="fas fa-minus inner_one_i2"></i></button>
                                 <button class="plus-middle inner_two2"><span class="inner_two_span<?php echo $i; ?>">1</span></button>
                                 <button class="plus-two inner_three2" onclick="getplus('<?php echo $i; ?>')"><i class="fas fa-plus inner_three_i2"></i></button>
                              </div>
   ...
   $(document).ready(function(){
      ...
      $('select[name="varient_id"]').on('change', function() {
        ...
        var varient_id = $(this).val();
                ...
                $.ajax({
                    url: "getbyresturantvarient/"+encodeURI(varient_id),
                    type: "GET",
                    dataType: "json",
...
<script type="text/javascript">
   ...
   function getproduct(count,cat_id,catidurl)
   {
      ...
      if ($('#fruit'+count).is(':checked'))
      {
         ...
         $.ajax({
            url: "{{ route('resturantgetproductlist') }}",
            type:"POST",
            data:{cat_id: cat_id},
            success: function(result){
