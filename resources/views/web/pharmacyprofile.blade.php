         ...
         <div class="container-fluid con_cont12">
            <div class="row">
               ...
               <form method="POST" action="{{ route('webupdateprofile') }}">
                  ...
                  <div class="card shadow cont_card22">
                  <p class="cont_tellus">Delivery Address<span class="addnew_acc"><a href="{{ route('pharmacyaddaddressdetails')}}"><i class="fas fa-plus"></i> Add New Address</a></span></p>
                     <div class="container-fluid" style="margin-left: 8px;width: 98.6%;">
                        <div class="row" >
                           ...
                           <div class="col-xl-6">
                              ...
                              <p class="myaccount_add"><?php if($address->select_status == 1){?>Default Address<?php } else {?><a onclick="setaddress({{ $address->address_id}})">Set Default Address</a><?php }?> <span style="float: right;"><a href="{{ route('pharmacyupdateaddressdetails', $address->address_id)}}">Edit Address</a></span> </p>
                           </div>
                           <?php }?>
                        </div>
                     </div>
