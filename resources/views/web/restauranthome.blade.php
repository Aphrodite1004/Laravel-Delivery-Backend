         ...
         <div class="container-fluid" style="width: 92.2%;padding-top: 55px;">
            ...
            @foreach($category as $category)
                  <div class="col-lg-3 col-md-6">
                    ...
                    <div class="icon-box" >
                     <a href="{{url('resturantproductweb')}}/{{$category->resturant_cat_id}}" style="color: black">
                     {{$category->cat_image}}
                        <img src="{{ url(''.$category->cat_image)}}" width="100%">
                        <br><br>
                        <center><h4><span style="color: #41CF2E;">{{ $category->cat_name }}</span></h4></center> <br>
                        </a>
                  </div>
