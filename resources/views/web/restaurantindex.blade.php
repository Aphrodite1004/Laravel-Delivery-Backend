   ...
   @include("web.category_slider")
      ...
      <div class="container" >
         <div class="row">
            ...
            <div class="item">
                  <center >
                     <img src="{{ url('frontassets/image/f1.jpg') }}" class="secimg_ban shadow">
                  </center>
               </div>
               <div class="item">
                  <center >
                     <img src="{{ url('frontassets/image/f2.jpg') }}" class="secimg_ban shadow">
                  </center>
               </div>
               <div class="item">
                  <center >
                     <img src="{{ url('frontassets/image/f3.jpg') }}" class="secimg_ban shadow">
                  </center>
               </div>
               <div class="item">
                  <center >
            ...
            @foreach($storelist as $storelists)
                  ...
                  <div class="item">
                     <div class="card four_card2" style="width: 100%;">
                        <a href="{{ route('restauranthome',$storelists->vendor_id)}}">
                        ...
                        <div class="card-body">
                           <p style="color: black">{{$storelists->vendor_name}}</p>
                           <p class="index_parae23">{{$storelists->vendor_loc}}</p>
                           <p class="index_para2to"><span><i class="far fa-clock"></i> {{$storelists->opening_time}} till {{$storelists->closing_time}}<span style="float: right;"><i class="fas fa-home"></i>{{round($storelists->distance, 2)}} km</span></span></p>
                           <p style="font-size: 13px;margin-bottom: -2px;"><span><i class="fa fa-mobile"></i>{{$storelists->vendor_phone}}</span></p>
                        </div>
                     </div>
                  </div>
