                ...
                <div class="card-body">
                  <h4 class="card-title">Add Addon</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('parcelAddNewproductaddon')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success mr-2">Submit</button>
                     ...
                     <a href="{{route('parceladdon',$id)}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
