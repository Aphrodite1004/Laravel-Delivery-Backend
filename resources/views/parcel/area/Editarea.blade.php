                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('parcelUpdatearea',$area->vendor_area_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="deliverycharge" name="delivery_charge" placeholder="{{ __('messages.Enter')}} {{ __('messages.Delivery_Charge')}}"  value="{{$area->delivery_charge}}">
                    </div>
