              ...
              <div class="card">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="strick_price" placeholder="{{ __('messages.Strick_Price')}}">
                    </div>  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="unit"  placeholder="{{ __('messages.quator_half_full')}}">
                    </div>  
                 
                    <button type="submit" class="btn btn-success mr-2">{{ __('messages.Submit')}}</button>
                   
                     <a href="{{route('pharmacyvarient',$id)}}" class="btn btn-light">{{ __('messages.Cancel')}}</a>
                  </form>
                </div>
              </div>
            </div>
