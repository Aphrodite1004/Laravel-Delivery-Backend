                 ...
                 @endif
                    ...
                    <div class="form-group">
                        <label for="autocomplete">Address</label>
                            ...
                            <input type="text" class="form-control" style="margin-top: 5px;" id="cityadmin_address_arabic" value="{{$city->city_name_arabic}}" name="cityadmin_address_arabic" placeholder="أدخل العنوان">                      
                    </div>
                   @endif
                   @if($mapset->mapbox == 1 && $mapset->google_map == 0)
                   <div class="form-group">
