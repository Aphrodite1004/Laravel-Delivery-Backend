                ...
                <div class="card-body">
                  <h4 class="card-title">Update Deal</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('update-deal',$first_wallet_recharge->deal_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="min_wallet_recharge" value="{{$first_wallet_recharge->min_wallet_recharge}}">
                    </div>
                   
                
                <div class="form-group">
                      <label for="exampleInputName1">Free For</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="free_for" value="{{$first_wallet_recharge->free_for}}">
                    </div>
