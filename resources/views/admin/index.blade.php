...
@section ('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
				...
				Hi, {{$admin->admin_name}}. <small>{{ __('messages.heres whats happening with your store today.')}}</small>
			</h1>
          </div>
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mt-3 mb-2">
                                        <a href="{{ route('adminallexcelgenerator') }}" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600"><i class="fa fa-wallet mr-2 ml-n2"></i>{{ __('messages.Download_Report')}}</a>
                                    </div>
