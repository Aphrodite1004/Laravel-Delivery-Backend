              ...
              <div class="col-sm-4">
                ...
                <div class="deal-entry  green">
                   <div class="offer-discount">
                    <a href="{{route('insertfav',[$stores->store_id])}}"><i class="fa fa-heart" style="border:none !important;font-size: 29px;color:red !important"></i></a>
                  </div>
                  <div class="image">
                    <a href="#" target="_blank" title="#">
                      <img src="{{url($stores->store_image)}}" alt="#" class="img-responsive" style="width:100%; height:150px">
                    </a>
