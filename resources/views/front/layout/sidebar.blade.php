      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <div class="nav-link">
                <div class="profile-image">
                  <img src="{{url($admin_image)}}" alt="image"/>
            ...
            <li class="nav-item">
              <a class="nav-link" href="https://thecodecafe.in/gonearby/admin/index">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{route('banner')}}">
                ...
                <span class="menu-title">Banner1</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('banner2')}}">
                <i class="fa fa-window-restore menu-icon"></i>
                <span class="menu-title">Banner2</span>
              </a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="{{route('banner3')}}">
                <i class="fa fa-window-restore menu-icon"></i>
                <span class="menu-title">Banner3</span>
              </a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="{{route('banner4')}}">
                <i class="fa fa-window-restore menu-icon"></i>
                <span class="menu-title">Banner4</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('contest')}}">
                <i class="fa fa-cc menu-icon"></i>
                <span class="menu-title">Store Contest</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="{{route('photo')}}">
                <i class="fa fa-grav menu-icon"></i>
