                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('vendorUpdatesubcat',$subcat->subcat_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="subcat_name_arabic" value="{{$subcat->subcat_name_arabic}}" placeholder="{{ __('messages.Enter_SubCategory_Name')}}">
                    </div>
                    <!-- <div class="form-group">-->
