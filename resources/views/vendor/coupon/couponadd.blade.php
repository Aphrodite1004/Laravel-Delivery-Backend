                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('addcoupon')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="coupon_name_arabic" placeholder="{{ __('messages.Coupon_Name_Arabic')}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="coupon_desc_arabic" placeholder="{{ __('messages.Arabic Coupon Description')}} ">
                    </div> 
