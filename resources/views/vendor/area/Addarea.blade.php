                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('vendorAddInsertarea')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="deliverycharge" name="delivery_charge" placeholder="{{ __('messages.Delivery_Charge')}}">
                    </div>
                    ...
                    -->
                     <a href="{{route('vendorarea')}}" class="btn btn-light">{{ __('messages.Cancel')}}</a>
                  </form>
                </div>
              </div>
            </div>
