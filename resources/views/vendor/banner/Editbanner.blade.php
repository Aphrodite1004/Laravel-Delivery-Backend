              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('Updatebannervendor',$banner->banner_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.banner_Name')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" value="{{$banner->banner_name}}" name="banner_name" placeholder="{{ __('messages.banner_Name')}}">
                    </div>
                    <!-- <div class="form-group">-->
                    ...
                    -->
                     <a href="{{route('bannervendor')}}" class="btn btn-light">{{ __('messages.Cancel')}}</a>
                  </form>
                </div>
              </div>
            </div>
