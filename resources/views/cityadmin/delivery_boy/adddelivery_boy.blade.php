                  ...
                  <form class="forms-sample" action="{{route('AddNewdelivery_boy')}}" method="post" enctype="multipart/form-data">
                    ...
                    <label for="exampleFormControlSelect3">{{ __('messages.choose_area')}}</label><br>
                     ...
                     <select class="mdb-select colorful-select dropdown-primary md-form" multiple searchable="Search here.." name="area_id[]" required>
                      <option value="" disabled style="background: #f1f1f1;">{{ __('messages.choose_area')}}</option>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="exampleInputName1" name="password1" placeholder="{{ __('messages.Password')}}" required>
                    </div>
                    ...
                    <div class="form-group">
                    <label for="exampleFormControlSelect3">{{ __('messages.Confirm_Password')}}</label><br>
                  
                     <select class="mdb-select colorful-select dropdown-primary md-form" multiple searchable="Search here.." name="vendor_id[]" required>
                      <option value="" disabled style="background: #f1f1f1;">{{ __('messages.choose vendor')}}</option>
