            ...
            <div class="card-body">
                ...
                <select class="form-control form-control-sm" id="exampleFormControlSelect3 " name="vendor_category_id">
                    @foreach($vendor_category as $category)
                        ...
                        @else
                        <option value="{{$category->vendor_category_id}}" @if($category->vendor_category_id == $vendor->vendor_category_id) selected @endif>{{$category->category_name_arabic}}</option>
                        @endif
                    @endforeach
                </select>
                </div>
                ...
                <div class="form-group">
                    <label for="exampleInputName1">{{ __('messages.Vendor Name arabic')}}</label>
                    <input type="text" class="form-control" name="vendor_name_arabic" placeholder="{{ __('messages.Vendor Name arabic')}}" value="{{$vendor->vendor_name_arabic}}">
                </div>                
                <div class="form-group">
