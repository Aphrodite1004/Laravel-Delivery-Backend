...
class CityController extends Controller
{
    ...
    public function AddInsertcity(Request $request)
    {
        $this->validate(
            $request,
                ...
                [
                    ...
                    'city_name_arabic.required' => 'أدخل العنوان',
                    'city_image.required' => 'choose picture.',
                ]
        );
   
    	$city_name=$request->city_name;
    	$city_name_arabic = $request->city_name_arabic;
        $city_image=$request->city_image;

        $created_at=date('d-m-Y h:i a');;
        $date = date('d-m-Y');
        $address = str_replace(" ", "+", $city_name);
        $address_arabic = str_replace(" ", "+", $city_name_arabic);
      ...
      $insert = DB::table('city')
    				->insert(['city_name'=>$city_name, 'city_name_arabic'=>$city_name_arabic, 'city_image'=>$city_image,'lat'=>$lat, 'lng'=>$lng, 'created_at'=>$created_at]);
...
{   
        ...
        $city_name_arabic = $request->cityadmin_address_arabic;
        ...
        $update = DB::table('city')
                                ->where('city_id', $city_id)
                                ->update(['city_name'=>$city_name, 'city_name_arabic'=>$city_name_arabic, 'city_image'=>$city_image,'lat'=>$lat, 'lng'=>$lng, 'updated_at'=>$updated_at]);
