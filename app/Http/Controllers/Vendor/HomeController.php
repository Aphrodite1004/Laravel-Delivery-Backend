...
class HomeController extends Controller
{
    ...
    public function vendorIndex(Request $request)
     ...
     if(Session::has('vendor'))
     {
        ...
        return view('vendor.index', compact("vendor_email", "vendor", "total_earnings", "total_users", "ongoing","complete","cityadmin","orders","user","comment","cancel","total_cash","currency","app_share","daily_count","today","recent_order","reffer_arning","created_at"));
